...
ICONS = {
    ...
    # 圆+勾 — 完成 / 确认（进度阶段专用，与 success 同形但语义区分）
    'check': (
        '<circle cx="12" cy="12" r="10"/>'
        '<polyline points="8,12 11,15 16,9"/>'
    ),
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    # 侧边栏设置区块标题（与 sidebar_mode_label 同风格的单行标题图标）
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    # 模型区：芯片（CPU）
    'ai_model': (
    ...
    'doc_scan': (
        ...
        '<line x1="9" y1="8" x2="15" y2="8"/>'
        '<line x1="9" y1="12" x2="15" y2="12"/>'
        '<line x1="3" y1="17" x2="21" y2="17" stroke-dasharray="2 2"/>'
    ),
    # 三层椭圆堆叠 — 知识库
    'kb': (
        '<ellipse cx="12" cy="6" rx="8" ry="3"/>'
    ...
    # 上升折线 + 放大镜 — 深度分析
    'analysis': (
        '<polyline points="3,18 8,12 13,15 20,6"/>'
        '<circle cx="17" cy="17" r="4"/>'
        '<line x1="19.5" y1="19.5" x2="22" y2="22"/>'
    ),
    # 钢笔尖 — 撰写 / 生成
    'pen': (
        '<path d="M12,20 L5,7 L12,2 L19,7 Z"/>'
    ...
    'satellite': (
        ...
        '<path d="M9,9 A5,5 0 0,1 15,9"/>'
    ),
    # 盾牌 + 内勾 — 可信度评估
    'shield': (
        '<path d="M12,2 L20,7 L20,13 C20,17.5 16,21 12,22 C8,21 4,17.5 4,13 L4,7 Z"/>'
        '<polyline points="8,12 11,15 16,9"/>'
    ),
    # 四节点连线 — 知识图谱
    'graph': (
