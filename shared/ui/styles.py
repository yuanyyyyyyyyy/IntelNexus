...
<style>
    ...
    * {
    ...
    /* === Briefing Workbench Theme (overrides morandi inside bf-workbench) === */
    .bf-workbench {
        --wb-surface: #F4F5F7;
        --wb-card: #FFFFFF;
    ...
    /* Page title override inside workbench */
    .bf-workbench .main-title {
...
def render_workbench_css():
    ...
    st.markdown("""
<style>
    /* Scoped to briefing tab only via parent container class */
    .bf-workbench {
        --wb-surface: #F4F5F7;
        --wb-card: #FFFFFF;
        --wb-text-primary: #111827;
    ...
    .bf-workbench div[data-testid="stButton"] > button[kind="primary"],
    ...
    .bf-workbench .briefing-step-card,
    .bf-workbench .briefing-tip-box,
    .bf-workbench .briefing-config-panel,
    .bf-workbench .briefing-config-divider {
        display: none !important;
    }

    /* Status dots keep working but smaller */
    .bf-workbench .status-dot {
        width: 6px;
        height: 6px;
    }
</style>
